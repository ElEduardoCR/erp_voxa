                ...
                <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-800/40 p-6 rounded-3xl border border-slate-700/50 backdrop-blur-sm">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-400 text-sm mt-1">Manage quotations and generate PDF proposals</p>
                        </div>
                    </div>
                                ...
                                {isLoading ? (
                                    ...
                                    <tr>
                                        <td colSpan={9} className="px-6 py-12 text-center text-slate-400">
                                            ...
                                            <p className="text-lg text-slate-300 font-medium">No quotations found</p>
